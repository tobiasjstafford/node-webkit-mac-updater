...
Updater.prototype = {
    ...
    update: function(callback) {
        ...
        try {
            this.download(this.config.https, this.config.source, location, function(){
    ...
    // private
    download: function(https, options, location, callback, progress) {
        var mod = require(https ? 'https' : 'http');
        var request = mod.get(options, function(res){
